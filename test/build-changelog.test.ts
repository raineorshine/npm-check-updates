...
// the working directory created by the current test, removed in afterEach
...
afterEach(async () => {
  ...
  vi.restoreAllMocks()
  vi.unstubAllGlobals()
  // remove only after chdir, otherwise the cwd is still inside the directory being deleted
  if (tempDir) {
