...
<!-- markdownlint-disable MD040 MD046 MD051 -->
...
- Apply boolean false from the rc config as --no-<option> by @XhmikosR in https://github.com/raineorshine/npm-check-updates/pull/2008
...
- Restore `CHANGELOG.md` and automate release-driven changelog sync by @raineorshine with @Copilot in https://github.com/raineorshine/npm-check-updates/pull/2014
- Add min-release-age=7 to .npmrc by @XhmikosR in https://github.com/raineorshine/npm-check-updates/pull/2025
...
- Replace the unmaintained npm-run-all with npm-run-all2 and remove unused deps by @XhmikosR in https://github.com/raineorshine/npm-check-updates/pull/1806
