...
function initOptions(options) {
  ...
  if (options.target && options.greatest) {
    throw new Error('Cannot specify both --target and --greatest. --greatest is an alias for "--target greatest".')
  }
  else if (options.target && options.newest) {
    throw new Error('Cannot specify both --target and --newest. --newest is an alias for "--target newest".')
  }
  else if (options.greatest && options.newest) {
    throw new Error('Cannot specify both --greatest and --newest. --greatest is an alias for "--target greatest" and --newest is an alias for "--target newest".')
  }
