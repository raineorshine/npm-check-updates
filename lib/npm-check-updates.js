...
function analyzeProjectDependencies(packageFile) {
    ...
    return Promise.props({
        ...
        return upgradePackageDefinitions(results.current)
            .spread(function (upgradedDependencies, latestVersions) {
                print('');
                ...
                if (!_.isEmpty(upgradedDependencies)) {
                    if (program.upgrade) {
                        upgradePackageFile(packageFile, results.current, upgradedDependencies)
                            .then(function () {
