...
const doctorHelpText = `Usage: ncu --doctor [-u]
...
5. For each dependency, install and run tests.
6. When the breaking upgrade is found, saves partially upgraded package.json (not including the breaking upgrade) and bails.
