...
const cliOptions = [
  ...
  {
    name: '--greatest',
    description: 'find the highest versions available instead of the latest stable versions (--target greatest)'
  },
  {
    name: '-i, --interactive',
  ...
  {
    name: '-n, --newest',
    description: 'find the newest versions available instead of the latest stable versions (--target newest)'
  },
  {
...
module.exports = { cliOptions, supportedVersionTargets }
