...
/**
 * Merge options by a standard way, but if some properties both are arrays, then merge them also.
 */
...
module.exports = { run, getNcurc, getPeerDependencies, mergeOptions, ...vm }
