...
module.exports = {
    ...
    list({ prefix }) {
        ...
        return new Promise((resolve, reject) => {
            bower.commands.list(null, {cwd: prefix})
                .on('end', results => {
    ...
    latest(packageName, _, { prefix }) {

        return new Promise((resolve, reject) => {
            bower.commands.info(packageName, null, {cwd: prefix})
                .on('end', results => {
