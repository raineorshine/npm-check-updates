...
function initialize(args) {
    ...
    // accept mock package managers (loose interface check)
    // see lib/package-managers/README.md for full interface
    selectedPackageManager = args.packageManager.init ?
        args.packageManager :
        getPresetPackageManager(args.packageManager);
